...
# ========== HYPERPARAMETERS ==========
# Model configuration
MODEL_NAME="$HOME/reasoning/Advantage_SimPER/outputs"/"llama3.1-8b-asimpo-0.1-1e-6/FINAL"
BETA=0.1
LEARNING_RATE=1e-7
USE_PEFT=true
...
DATASETS="[data/llama_math_advantage_feedback.json]"
CACHE_DIR="$HOME/reasoning/Advantage_SimPER/outputs"
TEST_DATASET="hendrycks_math"
NUM_SAMPLES_PER_PROMPT=8 # for sampling

# Output naming
EXP_NAME="llama3.1-8b-asimper-${BETA}-${LEARNING_RATE}"
OUTPUT_FILE="outputs/llama3.1-8b-asimper-${BETA}-${LEARNING_RATE}.json"

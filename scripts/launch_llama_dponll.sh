...
DATASETS="[data/llama_train_math_pairwise_feedback.json]"
CACHE_DIR="outputs"
TEST_DATASET="hendrycks_MATH"
NUM_SAMPLES_PER_PROMPT=8 # for sampling

# Output naming
EXP_NAME="llama3.1-8b-dponll-${BETA}-${LEARNING_RATE}"
OUTPUT_FILE="outputs/llama3.1-8b-dponll-${BETA}-${LEARNING_RATE}.json"
